...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if(isset($_POST['send-btn'])){
    ...
    if(mysqli_num_rows($check_email) > 0){
      ...
      $result = mysqli_query($db, "INSERT INTO user (email,fullName,phone,city,address, password,role) VALUES ('$email','$fullName','$phone','$city','$address', '$password','$role')");
...
<body  onload="document.body.style.opacity='1' ">
  ...
  <header class="header">
    ...
    <li class="menu-choice"><a href="index.php" class="active">الرئيسية</a></li>
      <li class="menu-choice"><a href="seller.php">انضم كبائع</a></li>
      <li class="menu-choice"><a href="buyer.php">انضم كمشتري</a></li>
  ...
  <div class="userForm" id="login">
    ...
    <h2 class="Title" >التسجيل كمشتري</h2>
    <?php if (!empty($msg)) {
    ...
    <a href="seller.php" class="forget">أنا صاحب متجر..أود التسجيل كبائع</a>
  </div>
