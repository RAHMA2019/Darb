...
/*if (!isset($_SESSION['loggedin'])) {
	header('Location: updateLinks.php');
	exit;
}*/
...
if(isset($_POST['upload-btn'])){
    ...
    // Convert to base64 
        ...
        try{
            ...
            // Insert record
            $query = "insert into links(title,linktxt,path) values('".$title."', '".$linktxt."','".$image."')";
...
<head>
    ...
    <title>سيما للتسويق الإلكتروني | إضافة مقالة</title>
...
<body>
   ...
   <!--form-->
    <div class="userForm">
        ...
        <h2 class="bigTitle">إضافة مقالة</h2><br/>
            <input type="text" id="title" name="title" placeholder="العنوان">
            <input type="text" id="linktxt" name="linktxt" placeholder="رابط المقالة">
        ...
        ?>
           ...
           <div class="images">
               ...
               <img class="imgAd" src='<?php echo $row[3];?>'>
...
if(isset($_POST["del-btn"])&& isset($_POST["ID"])) { 
   $query = mysqli_query($db,"DELETE FROM links WHERE ID = '".$_POST["ID"]."' ");
