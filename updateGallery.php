...
<head>
    ...
    <title>سيما للتسويق الإلكتروني | إضافة أعمالي</title>
...
<body>
   ...
   <!--form-->
    <div class="userForm">
        ...
        <h2 class="bigTitle">إضافة أعمالي</h2><br/>
            <input type="text" id="title" name="title" placeholder="العنوان">
            <input type="text" id="description" name="description" placeholder="الوصف">
...
if(isset($_POST["del-btn"])&& isset($_POST["ID"])) { 
   $query = mysqli_query($db,"DELETE FROM gallery WHERE ID = '".$_POST["ID"]."' ");
